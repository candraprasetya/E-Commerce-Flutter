...
import 'package:ecommerce_shoes/data.dart';
import 'package:ecommerce_shoes/utils.dart';
        ...
        children: <Widget>[
          Stack(
            children: <Widget>[
              ...
              Padding(
                padding: const EdgeInsets.only(top: 100.0, right: 35.0),
                child: Align(
                  ...
                  child: Container(
                    ...
                    child: Image.asset("assets/3dRotate.png"),
                  ),
                ),
              )
            ],
  ...
  return Padding(
    ...
    child: Container(
      ...
      child: Center(
        child: Text(size,
            style:
                TextStyle(color: Colors.white, fontFamily: "SFProDisplay-Bold")),
      ),
    ),
  );
}
